        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="bg-white/5 border border-white/20 rounded-full px-4 py-1 inline-block mb-4">
              <span className="text-white/70 text-sm font-medium">Identity Management</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-1 bg-white/10 border border-white/20 rounded-xl p-6 flex flex-col items-center">
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <UserCheck className="h-10 w-10 text-white/70 mb-4" />
            ...
            <motion.div 
              ...
              className="bg-white/10 border border-white/20 rounded-xl p-6"
            >
              <UserCog className="h-10 w-10 text-white/70 mb-4" />
            ...
            <motion.div 
              ...
              className="bg-white/10 border border-white/20 rounded-xl p-6"
            >
              <Key className="h-10 w-10 text-white/70 mb-4" />
            ...
            <motion.div 
              ...
              className="bg-white/10 border border-white/20 rounded-xl p-6"
            >
              <Fingerprint className="h-10 w-10 text-white/70 mb-4" />
            ...
            <motion.div 
              ...
              className="bg-white/10 border border-white/20 rounded-xl p-6"
            >
              <History className="h-10 w-10 text-white/70 mb-4" />
