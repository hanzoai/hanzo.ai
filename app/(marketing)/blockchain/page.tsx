      ...
      <section className="pt-24 pb-16 px-4 md:px-8 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <motion.div
            ...
            className="rounded-2xl border border-[#ffffff]/20 bg-gradient-to-br from-[#ffffff]/20 to-transparent p-8 md:p-12"
          >
            <div className="grid grid-cols-3 md:grid-cols-6 gap-6">
              {[
                ...
                return (
                  ...
                  >
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl bg-[#ffffff]/10 border border-[#ffffff]/30 flex items-center justify-center">
                      <Icon className="w-6 h-6 md:w-8 md:h-8 text-[#ffffff]" />
                    </div>
          ...
          >
            {[
              ...
              >
                ...
                <div className="text-sm font-medium text-[#ffffff]">{stat.label}</div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="mt-3 flex items-center gap-1 text-xs text-[#ffffff] opacity-0 group-hover:opacity-100 transition-opacity">
                      Get started
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#ffffff]/30 bg-[#ffffff]/10 mb-6">
                ...
                <span className="text-sm font-medium text-[#ffffff]">Unified Platform</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-medium text-white mb-4">
                AI + Web3.<br />
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-3 text-neutral-300">
                    <div className="w-6 h-6 rounded bg-[#ffffff]/10 flex items-center justify-center">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {ROADMAP.map((item, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-4 md:left-1/2 w-3 h-3 rounded-full -translate-x-1/2 bg-[#ffffff]" />

                  {/* Content */}
                  <div className={`ml-12 md:ml-0 md:w-1/2 ${index % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12"}`}>
                    <div className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-[#ffffff]/10 text-[#ffffff] border border-[#ffffff]/30 mb-2">
                      {item.phase}
                    </div>
      ...
      <section className="py-24 px-4 md:px-8 border-t border-neutral-900">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="rounded-2xl border border-[#ffffff]/30 bg-gradient-to-br from-[#ffffff]/20 to-transparent p-8 md:p-12 text-center"
          >
            <div className="w-16 h-16 rounded-2xl bg-[#ffffff]/10 flex items-center justify-center mx-auto mb-6">
              <Blocks className="w-8 h-8 text-[#ffffff]" />
            </div>
            <h2 className="text-3xl md:text-4xl font-medium text-white mb-4">
