    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-gray-950">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            <div className="relative overflow-hidden rounded-lg bg-black/50 p-6 h-64 flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-indigo-500/10"></div>
              <div className="relative z-10 text-center">
                <div className="text-2xl font-bold text-white mb-4">Modular Architecture</div>
                <p className="text-gray-400">Visualization of the Hanzo Bot architecture would appear here</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gray-900/20 border border-gray-800 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-white mb-2">Character Files</h3>
            ...
            <div className="bg-gray-900/20 border border-gray-800 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-white mb-2">Runtime</h3>
              <p className="text-gray-400">
