  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-24">
      <motion.div
        ...
        className="bg-gradient-to-br from-[#fd4444]/30 to-[#fd4444]/10 rounded-2xl border border-[#fd4444]/20 overflow-hidden"
      >
        <div className="h-64 bg-gradient-to-r from-[#fd4444]/30 to-[#ff6b6b]/30 flex items-center justify-center">
        ...
        <div className="p-8">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            <span className="px-3 py-1 bg-[#fd4444]/20 rounded-full text-sm text-[#fd4444] border border-[#fd4444]/30">
              AI Engineering
            </span>
            <span className="px-3 py-1 bg-[#ff6b6b]/20 rounded-full text-sm text-[#ff6b6b] border border-[#ff6b6b]/30">
              Cloud Infrastructure
            </span>
            <span className="px-3 py-1 bg-[#fd4444]/15 rounded-full text-sm text-[#fd4444] border border-[#fd4444]/25">
              Data Analytics
            </span>
          ...
          <Button asChild className="w-full bg-[#fd4444] hover:bg-[#e03e3e]">
      ...
      >
        <div className="h-64 bg-gradient-to-r from-[#ff6b6b]/30 to-[#fd4444]/30 flex items-center justify-center">
          <ChromeText as="h2" className="text-3xl font-bold">
            Industries
          </ChromeText>
        </div>
        <div className="p-8">
          ...
          <Button asChild className="w-full bg-[#ff6b6b] hover:bg-[#fd4444]">
