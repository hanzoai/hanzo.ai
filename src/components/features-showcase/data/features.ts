...
const aiCloudFeatures: Feature[] = [
  {
    ...
    icon: Brain,
    color: "bg-gradient-to-br from-[#fd4444] to-[#ff6b6b]",
    link: "/ai",
    category: "ai-cloud"
  },
  {
    ...
    icon: Database,
    color: "bg-gradient-to-br from-[#fd4444] to-rose-700",
    link: "/vector",
    category: "ai-cloud"
  },
  {
    ...
    icon: MessageSquare,
    color: "bg-gradient-to-br from-[#ff6b6b] to-[#fd4444]",
    link: "/teamchat",
    category: "ai-cloud"
  },
  {
...
const dxPlatformFeatures: Feature[] = [
  ...
  },
  {
    ...
    icon: Bot,
    color: "bg-gradient-to-br from-[#fd4444] to-pink-700",
    link: "/bot",
    category: "dx-platform"
  },
  {
...
const explorePlatform: Feature = {
  ...
  icon: ArrowRight,
  color: "bg-gradient-to-r from-[#fd4444] to-[#ff6b6b]",
  link: "/platform"
};
