      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-2">High Throughput</h3>
            ...
            <div className="mt-6 pt-6 border-t border-gray-800">
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-400 text-sm">Message throughput</span>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Concurrent Connections</h3>
            <p className="text-gray-300">
            ...
            <div className="mt-6 pt-6 border-t border-gray-800">
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-400 text-sm">Connection capacity</span>
                <span className="text-white font-medium">Millions+</span>
              </div>
              <div className="w-full bg-gray-800 h-2 rounded-full overflow-hidden">
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t border-gray-800">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-white font-medium">200+ regions</span>
              </div>
              <div className="w-full bg-gray-800 h-2 rounded-full overflow-hidden">
        ...
        >
          <div className="bg-black/40 rounded-lg border border-gray-800 p-4 flex items-center">
            <Zap className="h-8 w-8 text-purple-400 mr-4" />
            <div>
              <h4 className="text-white font-medium">Auto-scaling</h4>
              <p className="text-gray-400 text-sm">Scales automatically based on demand</p>
            </div>
          </div>
          ...
          <div className="bg-black/40 rounded-lg border border-gray-800 p-4 flex items-center">
            ...
            <div>
              <h4 className="text-white font-medium">High Availability</h4>
              <p className="text-gray-400 text-sm">99.99% uptime SLA guarantee</p>
            </div>
          </div>
          ...
          <div className="bg-black/40 rounded-lg border border-gray-800 p-4 flex items-center">
            ...
            <div>
              <h4 className="text-white font-medium">Zero Management</h4>
              <p className="text-gray-400 text-sm">No servers or infrastructure to manage</p>
            </div>
          </div>
        </motion.div>
      </div>
