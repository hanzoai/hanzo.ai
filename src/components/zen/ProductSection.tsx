        ...
        {products.map((product, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-[var(--black)]/30 p-4 rounded-lg border border-[#fd4444]/10 hover:border-[#fd4444]/30 transition-colors"
            >
              <h4 className="text-lg font-semibold text-[#fd4444] mb-1">{name}</h4>
