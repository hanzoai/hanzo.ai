      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center justify-center p-6 bg-black/50 rounded-xl">
              <div className="text-4xl font-bold text-white mb-2">4.8M+</div>
              <div className="text-gray-400">Monthly Deploys</div>
            </div>
          ...
          <div className="mt-8 bg-black/50 p-4 rounded-xl">
            <div className="h-40 w-full bg-gray-900/50 rounded-lg flex items-center justify-center">
              <p className="text-gray-500">Usage Metrics Visualization</p>
            </div>
          </div>
        </motion.div>
      </div>
