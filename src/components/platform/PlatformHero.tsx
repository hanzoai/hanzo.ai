              ...
              <div className="bg-gray-950 border border-gray-900/50 rounded-lg p-6">
                <div className="grid grid-cols-1 gap-4">
                  <div className="bg-[var(--black)]/80 border border-gray-800/50 rounded-lg p-4 flex items-start">
                    ...
                    <div>
                      <h3 className="text-[var(--white)] text-sm font-medium mb-1">Local Development</h3>
                  ...
                  <div className="bg-[var(--black)]/80 border border-gray-800/50 rounded-lg p-4 flex items-start">
                    ...
                    <div>
                      <h3 className="text-[var(--white)] text-sm font-medium mb-1">Data Sovereignty</h3>
                  ...
                  <div className="bg-[var(--black)]/80 border border-gray-800/50 rounded-lg p-4 flex items-start">
                    ...
                    <div>
                      <h3 className="text-[var(--white)] text-sm font-medium mb-1">Self-Hosting</h3>
