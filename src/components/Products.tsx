    ...
    <div className="bg-gray-900 rounded-lg border border-gray-800 p-4 w-full max-w-xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="flex-1 bg-gray-800 text-white border border-gray-700 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
        />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl font-semibold text-white">Try Hanzo Chat</h3>
            <p className="text-gray-400">Powered by our OpenAI-compatible API</p>
          </div>
          <ChatExample />
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="bg-gray-950 rounded-md p-3 font-mono text-sm text-gray-400 mb-4 overflow-x-auto">
                {product.code}
              </div>
        ...
        >
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="text-2xl font-semibold text-white mb-4">Ready to Start Building?</h3>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              >
                <a href="https://docs.hanzo.ai" target="_blank" rel="noopener noreferrer">
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto bg-transparent text-white hover:bg-white hover:text-black border-2 border-white transition-all duration-300"
                  >
                    Read the Docs
                  </Button>
                </a>
              ...
              >
                <a href="https://app.hanzo.ai/signup" target="_blank" rel="noopener noreferrer">
                  <Button
                    className="w-full sm:w-auto bg-white text-black hover:bg-gray-100 transition-all duration-300"
                  >
                    Get Started Free
                  </Button>
                </a>
