...
const principles = [
  {
    ...
    icon: <Users className="h-10 w-10 text-[#fd4444]" />,
  },
  {
  ...
  },
  {
    ...
    icon: <RefreshCcw className="h-10 w-10 text-[#fd4444]" />,
  },
  {
    ...
    icon: <Heart className="h-10 w-10 text-[#fd4444]" />,
  },
  {
    ...
    icon: <BookOpen className="h-10 w-10 text-[#fd4444]" />,
  }
];
