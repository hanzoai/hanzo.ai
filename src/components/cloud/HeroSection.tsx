...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#fd4444]/15 via-[#ff6b6b]/10 to-black opacity-40"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <div className="inline-block px-4 py-1 rounded-full bg-[#fd4444]/20 border border-[#fd4444]/30 text-[#fd4444] text-sm font-medium mb-6">
        ...
        >
          <Button size="lg" className="text-lg px-8 bg-gradient-to-r from-[#fd4444] to-[#ff6b6b] hover:from-[#e03e3e] hover:to-[#fd4444] border-none">
          ...
          <Button 
            variant="outline"
            size="lg" 
            className="text-lg px-8 text-[var(--white)] border-[#fd4444]/30 hover:bg-[#fd4444]/10"
          >
        ...
        >
          <div className="bg-gray-900/30 border border-[#fd4444]/20 rounded-xl p-6 text-center">
            <Server className="h-8 w-8 text-[#fd4444] mx-auto mb-4" />
          ...
          <div className="bg-gray-900/30 border border-[#fd4444]/20 rounded-xl p-6 text-center">
            <Zap className="h-8 w-8 text-[#fd4444] mx-auto mb-4" />
          ...
          <div className="bg-gray-900/30 border border-[#fd4444]/20 rounded-xl p-6 text-center">
            <Globe className="h-8 w-8 text-[#fd4444] mx-auto mb-4" />
