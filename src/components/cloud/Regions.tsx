          ...
          >
            ...
            <div className="rounded-lg bg-gray-900/50 border border-gray-800 overflow-hidden">
              ...
              <div className="p-4 font-mono text-sm text-gray-300">
                ...
                <div className="text-gray-400">Deploying to region: us-east-1</div>
                <div className="text-gray-400">Building container image...</div>
                <div className="text-gray-400">Pushing to registry...</div>
                <div className="text-purple-400">✓ Deployed in 250ms</div>
                <div className="text-gray-400">Your app is live at: <span className="text-blue-400">https://myapp.hanzo.cloud</span></div>
              </div>
            </div>
          </motion.div>
