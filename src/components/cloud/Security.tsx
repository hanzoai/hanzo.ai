  ...
  return (
    <section id="security" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-black">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Shield className="w-16 h-16 text-[#fd4444] mx-auto mb-6" />
        ...
        <div className="flex flex-col md:flex-row gap-16 items-start">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={index} className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-[#fd4444] mr-3 mt-1" />
          ...
          <motion.div
            ...
            className="flex-1"
          >
            <div className="bg-gradient-to-br from-[#fd4444]/10 to-[#ff6b6b]/10 rounded-xl p-8 border border-[#fd4444]/30">
