        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <div className="bg-black/50 rounded-lg p-6 font-mono text-sm">
              ...
              <div className="mb-4">
                <span className="text-blue-400">const</span> observability <span className="text-white">=</span> <span className="text-blue-400">new</span> <span className="text-yellow-300">HanzoObservability</span><span className="text-white">(</span><span className="text-orange-400">'YOUR_PROJECT_TOKEN'</span><span className="text-white">);</span>
              </div>
              <div className="mb-4">
                <span className="text-purple-400">// Trace AI model calls</span>
              </div>
              <div>
                <span className="text-blue-400">await</span> observability.<span className="text-yellow-300">trace</span><span className="text-white">(</span><span className="text-orange-400">'chatCompletion'</span><span className="text-white">, {'async () => {'}</span>
                <div className="pl-5 text-white">
                  <span className="text-blue-400">const</span> response <span className="text-white">=</span> <span className="text-blue-400">await</span> openai.<span className="text-yellow-300">createChatCompletion</span><span className="text-white">({'{...}'})</span>
          ...
          >
            {integrationGroups.map((group, groupIndex) => (
              <div key={groupIndex} className="mb-10">
                <h3 className="text-xl font-bold mb-6 text-gray-300">{group.title}</h3>
