    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--black)] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center justify-center mb-6 bg-[#fd4444]/20 p-3 rounded-full">
              <Shield className="h-7 w-7 text-[#fd4444]" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {securityFeatures.map((feature, index) => (
                ...
                >
                  <CheckCircle className="h-5 w-5 text-[#fd4444] mr-2 flex-shrink-0" />
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-0.5 bg-gradient-to-r from-[#fd4444]/20 to-[#ff6b6b]/20 rounded-xl blur opacity-75"></div>
            <div className="relative bg-[var(--black)] rounded-xl border border-gray-800 p-8">
              <div className="space-y-6">
                <div className="flex items-center">
                  <div className="p-2 bg-[#fd4444]/20 rounded-md mr-4">
                    <Shield className="h-6 w-6 text-[#fd4444]" />
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["SOC 2*", "GDPR", "HIPAA", "Privacy"].map((cert, idx) => (
                      <div key={idx} className="bg-gray-800/50 p-2 rounded flex items-center">
                        <CheckCircle className="h-4 w-4 text-[#fd4444] mr-2" />
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="w-24 h-2 bg-gray-700 rounded-full overflow-hidden">
                        <div className="w-5/6 h-full bg-[#fd4444]"></div>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm">Access Controls</span>
                      <div className="w-24 h-2 bg-gray-700 rounded-full overflow-hidden">
                        <div className="w-full h-full bg-[#fd4444]"></div>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
