        ...
        <div className="max-w-4xl mx-auto text-center mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 flex flex-col items-center">
              ...
              <p className="text-gray-400 mb-4 text-center">Launch your store with our easy-to-use platform</p>
              <Button 
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 flex flex-col items-center">
              ...
              <p className="text-gray-400 mb-4 text-center">Explore our guides and API references</p>
              <Button 
                className="mt-auto bg-amber-500 hover:bg-amber-600 text-black"
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 flex flex-col items-center">
              ...
              <p className="text-gray-400 mb-4 text-center">Integrate our APIs into your applications</p>
              <Button 
                className="mt-auto bg-amber-500 hover:bg-amber-600 text-black"
