...
const Commerce = () => {
  return <section className="py-20 bg-gradient-to-b from-black to-gray-900 bg-black">
...
const store = createStore();`}</code>
        ...
        <div className="text-center">
          <Button className="bg-white/5 hover:bg-white/10 text-white px-8 py-6 text-lg rounded-xl border border-white/10 hover:border-white/20">
