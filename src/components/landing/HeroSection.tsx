  ...
  return (
    <section className="pt-20 pb-8 px-4 md:px-8 lg:px-12">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, delay: 0.4 }}
        className="mx-auto w-full max-w-[1400px] mt-16 flex flex-col items-center"
      >
        <p className="text-xs uppercase tracking-widest text-neutral-500 mb-6">
          Backed by world-class investors & partners
        </p>
        <div className="flex flex-wrap justify-center items-center gap-x-10 gap-y-6 opacity-60 hover:opacity-80 transition-opacity">
          {/* Techstars */}
          <div className="flex items-center gap-2 text-neutral-400">
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
            </svg>
            <span className="text-sm font-medium tracking-tight">Techstars</span>
          </div>
          {/* NVIDIA */}
          <div className="flex items-center gap-2 text-neutral-400">
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="text-sm font-medium tracking-tight">NVIDIA</span>
          </div>
          {/* Google Cloud */}
          <div className="flex items-center gap-2 text-neutral-400">
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="text-sm font-medium tracking-tight">Google Cloud</span>
          </div>
          {/* Nebius */}
          <div className="flex items-center gap-2 text-neutral-400">
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="text-sm font-medium tracking-tight">Nebius</span>
          </div>
          {/* DigitalOcean */}
          <div className="flex items-center gap-2 text-neutral-400">
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12.04 2C6.49 2 2 6.49 2 12.04c0 5.24 4.02 9.54 9.16 9.96v-3.48h-2.78v-3.48h2.78v-2.65c0-2.74 1.64-4.26 4.13-4.26 1.19 0 2.44.21 2.44.21v2.69h-1.38c-1.36 0-1.78.84-1.78 1.7v2.05h3.03l-.48 3.48h-2.54v5.48C18.32 21.26 22 17.04 22 12.04 22 6.49 17.51 2 12.04 2z"/>
            </svg>
            <span className="text-sm font-medium tracking-tight">DigitalOcean</span>
          </div>
        </div>
        <p className="text-neutral-500 text-center text-sm mt-8 max-w-xl">
