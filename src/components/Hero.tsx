      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center">
          ...
          <motion.p
            ...
            transition={{ duration: 0.4, delay: 0.25 }} // Increased from 0.3, 0.2
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: titleAnimationComplete ? 1 : 0, y: titleAnimationComplete ? 0 : 20 }}
            transition={{ duration: 0.4, delay: 0.35 }} // Increased from 0.3, 0.3
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.5 }} // Increased from 0.4, 0.4
