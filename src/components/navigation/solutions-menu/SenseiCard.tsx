...
export const SenseiCard = ({ onCardClick }: SenseiCardProps) => {
  return (
    <a 
      ...
      className="block rounded-xl bg-gradient-to-b from-green-900/50 to-teal-900/50 border border-green-500/20 cursor-pointer hover:border-green-500/40 transition-colors p-3"
      onClick={onCardClick}
    >
