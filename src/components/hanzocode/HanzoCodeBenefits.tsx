            ...
            <div className="h-96 bg-gray-900 flex items-center justify-center p-8">
              <div className="space-y-4 text-left w-full">
                <div className="border-l-4 border-purple-500 pl-4 py-2">
                  <h3 className="font-semibold text-white">What Cursor/Windsurf Users Say:</h3>
                  <p className="text-gray-300 italic">"I switched to Hanzo Code and my productivity jumped 3x. The agent capabilities are on another level."</p>
                </div>
                
                <div className="border-l-4 border-blue-500 pl-4 py-2">
                  <p className="text-gray-300 italic">"Using my favorite VS Code setup with Hanzo's AI has transformed how I approach complex programming tasks."</p>
                </div>
                
                <div className="border-l-4 border-green-500 pl-4 py-2">
                  <p className="text-gray-300 italic">"Running parallel agent instances to solve different parts of the same problem simultaneously is a game-changer."</p>
                </div>
              </div>
            </div>
          </motion.div>
