          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="bg-black/40 backdrop-blur-sm border border-purple-500/20 rounded-lg p-8"
              >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="p-8 bg-gradient-to-br from-black/80 to-purple-900/20 backdrop-blur-sm border border-purple-500/20 rounded-lg">
                <h3 className="text-2xl font-bold text-white mb-4">The Time for Acceleration is Now</h3>
                <p className="text-gray-300 md:text-lg leading-relaxed mb-8">
                ...
                <div className="flex justify-center">
                  <a 
                    href="/platform" 
                    className="px-8 py-3 bg-purple-600 text-white rounded-md hover:bg-purple-500 transition-colors"
                  >
