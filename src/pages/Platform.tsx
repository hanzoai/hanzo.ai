          ...
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">100% Free & Open Source</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">✓</span>
                <span className="text-gray-300">Self-hosted on your hardware</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">✓</span>
                <span className="text-gray-300">Full data sovereignty</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">✓</span>
                <span className="text-gray-300">Perfect for local development</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-400 mr-2">✓</span>
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-500">Limited by your hardware</span>
              </li>
              <li className="flex items-start">
                <span className="text-gray-500 mr-2">○</span>
                <span className="text-gray-500">Manual scaling and maintenance</span>
              </li>
            </ul>
            <div className="mt-8 text-center">
              <a href="https://github.com/hanzo/platform" className="inline-block px-6 py-3 bg-green-600 hover:bg-green-500 text-white rounded-lg font-medium transition-colors">
                Get Started Free
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Fully managed infrastructure</span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-2">✓</span>
                <span className="text-gray-300">Global deployment in 35+ regions</span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-2">✓</span>
                <span className="text-gray-300">Automatic scaling with demand</span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-2">✓</span>
              ...
              <li className="flex items-start">
                <span className="text-purple-400 mr-2">✓</span>
                <span className="text-gray-300">High-performance GPU access</span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-2">✓</span>
                <span className="text-gray-300">Pay only for what you use</span>
              </li>
            </ul>
            <div className="mt-8 text-center">
              <a href="/cloud" className="inline-block px-6 py-3 bg-purple-600 hover:bg-purple-500 text-white rounded-lg font-medium transition-colors">
                Explore Cloud
              </a>
            </div>
          </motion.div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 mb-4">Run optimized language models locally for development and testing.</p>
          ...
          >
            ...
            <p className="text-gray-400 mb-4">High-performance vector storage and search for embeddings and RAG applications.</p>
            <div className="text-sm text-gray-500">Apache 2.0 Licensed</div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-400 mb-4">Fast, efficient model inference with batch processing and caching.</p>
            <div className="text-sm text-gray-500">MIT Licensed</div>
          </motion.div>
        </div>
