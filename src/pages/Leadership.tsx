  ...
  return (
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)]">
      <Helmet>
        ...
        <meta name="description" content="Meet the leadership team at Hanzo AI, a Techstars company founded to democratize access to AI." />
      </Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {leaders.map((leader, index) => (
                <motion.div
                  ...
                  className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-8 hover:border-[#fd4444]/30 transition-colors"
                >
              ...
              {[
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 hover:border-[#fd4444]/30 transition-colors text-center"
                  >
                    <div
