        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#fd4444]/30 bg-[#fd4444]/10 mb-6">
              ...
              <span className="text-sm font-medium text-[#fd4444]">Chain Resource Directory</span>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-8">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-lg bg-neutral-900 border border-neutral-800 text-white placeholder-neutral-500 focus:outline-none focus:border-[#fd4444]/50"
              />
            </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-lg bg-[#fd4444]/10 flex items-center justify-center">
                      <Globe className="w-5 h-5 text-[#fd4444]" />
                    </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          <div className="p-3 rounded-lg bg-neutral-950 font-mono text-xs">
                            ...
                            <span className="text-[#fd4444]">{chain.rpcEndpoint}</span>
                          </div>
                          {chain.wsEndpoint && (
                            <div className="p-3 rounded-lg bg-neutral-950 font-mono text-xs">
                              <span className="text-neutral-500">WS:</span>{" "}
                              <span className="text-[#fd4444]">{chain.wsEndpoint}</span>
                            </div>
                          )}
                        </div>
                      </div>
