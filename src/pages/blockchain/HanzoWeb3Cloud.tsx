    ...
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)]">
      ...
      <section className="pt-24 pb-16 px-4 md:px-8 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center">
          ...
          >
            <Cloud className="w-4 h-4 text-[#fd4444]" />
          ...
          >
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4">
              <div className="text-2xl font-bold text-[#fd4444]">100+</div>
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4">
              <div className="text-2xl font-bold text-[#fd4444]">&lt;50ms</div>
              <div className="text-sm text-neutral-400">Global Latency</div>
            </div>
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4">
              <div className="text-2xl font-bold text-[#fd4444]">ERC-4337</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {coreApis.map((api, index) => {
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-lg bg-[#fd4444]/10 flex items-center justify-center mb-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#fd4444]/10 border border-[#fd4444]/20 mb-6">
              <Wallet className="w-4 h-4 text-[#fd4444]" />
            ...
            {accountAbstraction.map((product, index) => {
              ...
              return (
                ...
                >
                  <Link
                    to={product.href}
                    className="block bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 hover:border-[#fd4444]/30 transition-colors h-full"
                  >
                    <div className="w-12 h-12 rounded-lg bg-[#fd4444]/10 flex items-center justify-center mb-4">
                      <Icon className="w-6 h-6 text-[#fd4444]" />
                    </div>
      ...
      <section className="py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
                ...
                <ul className="space-y-2">
                  {chains.map((chain, idx) => (
                    <li key={idx} className="flex items-center gap-2 text-sm text-neutral-300">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#fd4444]" />
                      {chain}
                    </li>
                  ))}
                </ul>
          ...
          >
            <Link
              to="/blockchain/directory"
              className="inline-flex items-center gap-2 text-[#fd4444] hover:text-[#ff6b6b] font-medium"
            >
            ...
            {whiteLabelProducts.map((product, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.05 }}
                  className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-5 hover:border-[#fd4444]/30 transition-colors"
                >
            ...
            {deploymentOptions.map((option, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.05 }}
                  className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4 hover:border-[#fd4444]/30 transition-colors"
                >
