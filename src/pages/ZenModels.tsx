...
// Model data based on actual specifications from ~/work/zen
const MODEL_FAMILIES = {
  coder: {
    title: "Coder Models",
    description: "State-of-the-art code generation and software engineering",
    icon: Code2,
    color: "#10b981",
    models: [
      {
