        ...
        <div className="max-w-6xl mx-auto">
          <AnimatedSection>
            ...
            <div className="mt-8 space-y-6">
              <div className="backdrop-blur-xl bg-black/40 border border-white/5 rounded-xl p-6">
                  ...
                  {services.map((service, index) => (
                    <div key={index} className="py-4 flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-300 mr-4">Operational</span>
                        <span className="text-gray-500">{service.uptime} uptime</span>
                      </div>
                    </div>
                  ))}
                </div>
