  ...
  return (
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)] relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-[#fd4444]/10 rounded-full blur-3xl transform translate-x-1/4 -translate-y-1/4"></div>
        <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-[#fd4444]/5 rounded-full blur-3xl transform -translate-x-1/4 translate-y-1/4"></div>
      </div>
      ...
      <main className="pt-20 pb-24">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-6">
                ...
                <Button
                  ...
                  className="flex-shrink-0 bg-[#fd4444] hover:bg-[#e03e3e]"
                >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  {
                    icon: <Share2 className="h-8 w-8 text-[#fd4444]" />,
                    title: "Share Your Link",
                    description: "Send your unique referral link to friends and colleagues."
                  },
                  {
                    icon: <Users className="h-8 w-8 text-[#fd4444]" />,
                  ...
                  <div key={index} className="bg-gray-900/20 border border-gray-800 rounded-xl p-6">
                    <div className="h-16 w-16 rounded-full bg-[#fd4444]/10 border border-[#fd4444]/20 flex items-center justify-center mb-4">
                      {step.icon}
                    </div>
        ...
        {/* CTA Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto bg-gradient-to-r from-[#fd4444]/10 to-[#ff6b6b]/10 rounded-xl border border-[#fd4444]/20 p-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[#fd4444] hover:bg-[#e03e3e] px-8">
