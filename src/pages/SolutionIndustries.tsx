      ...
      >
        <div className={`bg-gradient-to-br ${colorClasses[industry.color as keyof typeof colorClasses]} rounded-xl p-8 mb-10`}>
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            <div className="bg-white/10 rounded-full p-6 inline-flex">
              {industry.icon}
            </div>
            <div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {industry.challenges.map((challenge, idx) => (
                <li key={idx} className="flex items-start gap-3 bg-black/40 p-4 rounded-lg border border-gray-800">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {industry.caseStudy.results.map((result, idx) => (
                  <div key={idx} className="bg-black/40 p-4 rounded-lg border border-gray-800">
          ...
          <div className="space-y-4">
            <a href="#" className="flex items-center justify-between p-3 rounded-lg bg-black/40 hover:bg-black/60 transition-colors">
              <div className="flex items-center">
                ...
                <span className="text-white">The Future of AI in Financial Services</span>
              </div>
              <ExternalLink className="h-4 w-4 text-gray-400" />
            </a>
            <a href="#" className="flex items-center justify-between p-3 rounded-lg bg-black/40 hover:bg-black/60 transition-colors">
              <div className="flex items-center">
                <BookOpen className="h-5 w-5 text-indigo-400 mr-3" />
                <span className="text-white">Healthcare Interoperability Challenges</span>
              </div>
              <ExternalLink className="h-4 w-4 text-gray-400" />
            </a>
            <a href="#" className="flex items-center justify-between p-3 rounded-lg bg-black/40 hover:bg-black/60 transition-colors">
              <div className="flex items-center">
                <BookOpen className="h-5 w-5 text-indigo-400 mr-3" />
                <span className="text-white">Digital Transformation in Retail</span>
              </div>
              <ExternalLink className="h-4 w-4 text-gray-400" />
            </a>
          </div>
