  ...
  return (
    <div className="mb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        ...
        >
          <div className="bg-[#fd4444]/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
            <Users className="h-6 w-6 text-[#fd4444]" />
          </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-[#fd4444]/15 to-[#fd4444]/5 p-6 rounded-xl border border-[#fd4444]/20 hover:border-[#fd4444]/40 transition-all duration-300"
        >
          <div className="bg-[#fd4444]/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
      ...
      <div className="text-center">
        <Button asChild size="lg" className="bg-[#fd4444] hover:bg-[#e03e3e]">
          <Link to="/cloud">
