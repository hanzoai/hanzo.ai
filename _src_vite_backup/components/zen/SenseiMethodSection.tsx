    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--black)]/50">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="h-px w-20 bg-[#fd4444] mx-auto"></div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-[var(--black)]/20 backdrop-blur-sm border border-[#fd4444]/10 rounded-lg p-10 mb-10"
        >
          <div className="flex justify-center mb-8">
            <HexagonIcon className="h-16 w-16 text-[#fd4444] opacity-70" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12">
            <a
              ...
              className="flex items-center justify-between px-8 py-6 bg-gradient-to-r from-[#fd4444]/20 to-[#fd4444]/10 hover:from-[#fd4444]/30 hover:to-[#fd4444]/20 rounded-lg text-[var(--white)] transition-all group"
            >
              <div className="flex items-center">
                <BookOpen className="h-5 w-5 text-[#fd4444] mr-3" />
                <div>
