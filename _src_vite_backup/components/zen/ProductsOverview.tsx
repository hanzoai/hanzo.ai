...
const AICloudSVG = () => (
  <svg 
    className="absolute -bottom-10 -right-10 opacity-10 w-40 h-40 text-[#fd4444]" 
    viewBox="0 0 200 200" 
    fill="none"
          ...
          >
            {type === 'cloud' ? (
              <>
                <div className="mb-6">
                  <h3 className="text-2xl font-medium text-white mb-2 flex items-center">
                    <Cloud className="mr-2 h-6 w-6 text-[#fd4444]" />
                    Hanzo AI Cloud
                  </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <Brain className="h-5 w-5 text-[#fd4444] mr-2" />
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <Database className="h-5 w-5 text-[#fd4444] mr-2" />
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <Bot className="h-5 w-5 text-[#fd4444] mr-2" />
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <Lock className="h-5 w-5 text-[#fd4444] mr-2" />
                ...
                <div className="mt-6 pt-4 border-t border-white/10 flex justify-between items-center">
                  ...
                  <Link 
                    to="/ai" 
                    className="text-[#fd4444] hover:text-[#ff6b6b] transition-colors text-sm flex items-center"
                  >
              ...
              <>
                <div className="mb-6">
                  <h3 className="text-2xl font-medium text-white mb-2 flex items-center">
                    <Code className="mr-2 h-6 w-6 text-[#fd4444]" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <GitBranch className="h-5 w-5 text-[#fd4444] mr-2" />
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <Zap className="h-5 w-5 text-[#fd4444] mr-2" />
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <Network className="h-5 w-5 text-[#fd4444] mr-2" />
      ...
      <div className="max-w-screen-2xl w-full mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
            whileHover={{ y: -5 }}
            className="relative overflow-hidden rounded-2xl border border-[#fd4444]/20 bg-gradient-to-br from-red-950/20 to-black p-6 cursor-pointer group"
            onClick={() => setSelectedSystem('cloud')}
          >
            <div className="relative z-10">
              <div className="flex items-center mb-4">
                <div className="p-2 rounded-xl bg-[#fd4444]/10 mr-4">
                  <Cloud className="h-8 w-8 text-[#fd4444]" />
                </div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-2 py-1 bg-[#fd4444]/10 rounded-full text-xs text-[#ff6b6b]">Vector DB</span>
                <span className="px-2 py-1 bg-[#fd4444]/10 rounded-full text-xs text-[#ff6b6b]">Multi-Model</span>
                <span className="px-2 py-1 bg-[#fd4444]/10 rounded-full text-xs text-[#ff6b6b]">Agents</span>
                <span className="px-2 py-1 bg-[#fd4444]/10 rounded-full text-xs text-[#ff6b6b]">Enterprise Ready</span>
              </div>
              
              <button className="flex items-center text-[#fd4444] group-hover:text-[#ff6b6b] transition">
            ...
            <motion.div 
              className="absolute inset-0 bg-[#fd4444]/5 opacity-0 group-hover:opacity-100 transition-opacity"
              initial={false}
          ...
          >
            <div className="relative z-10">
              <div className="flex items-center mb-4">
                <div className="p-2 rounded-xl bg-[#fd4444]/10 mr-4">
                  <Code className="h-8 w-8 text-[#fd4444]" />
                </div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-2 py-1 bg-[#fd4444]/10 rounded-full text-xs text-[#ff6b6b]">CI/CD</span>
                <span className="px-2 py-1 bg-[#fd4444]/10 rounded-full text-xs text-[#ff6b6b]">Dev Tools</span>
                <span className="px-2 py-1 bg-[#fd4444]/10 rounded-full text-xs text-[#ff6b6b]">Edge</span>
                <span className="px-2 py-1 bg-[#fd4444]/10 rounded-full text-xs text-[#ff6b6b]">Observability</span>
              </div>
