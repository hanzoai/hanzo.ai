...
const timelineEvents = [
  {
    ...
    icon: <Rocket className="text-[#fd4444]" />,
  ...
  },
  {
    ...
    icon: <Stars className="text-[#fd4444]" />,
  ...
  },
  {
    ...
    icon: <Trophy className="text-[#fd4444]" />,
  ...
  },
  {
    ...
    icon: <Coins className="text-[#fd4444]" />,
  ...
  },
  {
    ...
    icon: <Code className="text-[#fd4444]" />,
  ...
  },
  {
    ...
    icon: <User2 className="text-[#fd4444]" />,
      ...
      <div className="md:w-1/2">
        <div className="bg-card backdrop-blur-sm border border-border rounded-lg p-8 h-full">
          <div className="flex items-center mb-4">
            ...
            <div>
              <span className="text-sm text-[#fd4444] font-semibold">{event.year}</span>
              <h3 className="text-2xl font-bold text-foreground">{event.title}</h3>
            </div>
          </div>
          <p className="text-muted-foreground mb-4">{event.description}</p>
          <div className="bg-[#fd4444]/10 border border-[#fd4444]/20 rounded-lg p-4 mb-6">
