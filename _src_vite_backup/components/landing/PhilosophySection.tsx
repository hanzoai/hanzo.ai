...
const PhilosophyItem: React.FC<PhilosophyItemProps> = ({ icon, title, description, delay }) => {
  return (
    ...
    >
      <div className="w-16 h-16 rounded-full bg-[#fd4444]/20 flex items-center justify-center mb-4">
        {icon}
      </div>
