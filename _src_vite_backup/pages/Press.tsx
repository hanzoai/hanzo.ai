      ...
      <main>
        ...
        <section className="relative pt-24 pb-16 px-4 md:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center">
              ...
              >
                Everything you need to write about Hanzo Industries Inc.
                Download our press kit, access brand assets, and find media contacts.
              </motion.p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                >
                  <Building2 className="w-5 h-5" style={{ color: BRAND_COLOR }} />
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="space-y-3">
                  <a
                    href="mailto:press@hanzo.ai"
                    className="flex items-center gap-3 text-neutral-300 hover:text-[#fd4444] transition-colors"
                  >
        ...
        <section className="py-16 px-4 md:px-8 bg-neutral-900/30">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <Link to="/brand">
                <Button variant="outline" size="sm" className="gap-2 border-neutral-700 text-white hover:bg-neutral-800">
            ...
            <div className="space-y-4">
              {pressReleases.map((release, index) => (
                ...
                >
                  <Link
                    to={release.link}
                    className="block p-6 rounded-xl bg-neutral-900/50 border border-neutral-800 hover:border-[#fd4444]/30 transition-all group"
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <div className="text-sm text-neutral-500 mb-2">{release.date}</div>
                        <h3 className="font-semibold text-white mb-2 group-hover:text-[#fd4444] transition-colors">
                          {release.title}
                        </h3>
                        <p className="text-sm text-neutral-400">{release.description}</p>
                      </div>
                      <ArrowRight className="w-5 h-5 text-neutral-600 group-hover:text-[#fd4444] group-hover:translate-x-1 transition-all flex-shrink-0" />
                    </div>
                  </Link>
                </motion.div>
              ))}
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="p-4 rounded-xl bg-neutral-900/50 border border-neutral-800 text-center hover:border-[#fd4444]/30 transition-all"
                >
        ...
        <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-neutral-900/30 to-black relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              For executive bios and headshots, visit our team page or contact our press team.
            </motion.p>
