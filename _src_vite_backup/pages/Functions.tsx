  ...
  return (
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)]">
      ...
      <section className="py-20 lg:py-32 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-[#fd4444]/10 to-transparent"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="bg-[#fd4444]/10 border border-[#fd4444]/20 rounded-full px-4 py-1 inline-block mb-4">
              <span className="text-[#fd4444] text-sm font-medium">Serverless Computing</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#fd4444] to-[#ff6b6b]">
              Hanzo Functions
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-[#fd4444] hover:bg-[#e03e3e] text-[var(--white)] px-8 py-6 text-lg">
                Get Started
              </Button>
              <Button variant="outline" className="border-[#fd4444]/30 text-[var(--white)] hover:bg-[#fd4444]/10 px-8 py-6 text-lg">
                View Documentation
              </Button>
            </div>
          </div>
          ...
          {/* Hero Visual */}
          <div className="relative bg-[#fd4444]/10 border border-[#fd4444]/20 rounded-xl p-8 overflow-hidden">
            <div className="absolute inset-0 bg-grid-white/5 [mask-image:linear-gradient(to_bottom,white,transparent)]"></div>
            <pre className="text-sm sm:text-base overflow-x-auto bg-[var(--black)]/50 p-4 rounded-lg border border-[#fd4444]/30">
              <code className="text-neutral-300">
                <span className="text-[#fd4444]">export</span> <span className="text-[#ff6b6b]">async function</span> <span className="text-green-400">handler</span><span className="text-[var(--white)]">(req, res) {'{'}</span>
                <br/>
                <span className="ml-4">// Process incoming data</span>
                <br/>
                <span className="ml-4 text-[#fd4444]">const</span> <span className="text-[var(--white)]">{'{'} data {'}'} = </span><span className="text-[#fd4444]">await</span> <span className="text-[var(--white)]">req.json();</span>
                <br/>
                <span className="ml-4 text-[#fd4444]">const</span> <span className="text-[var(--white)]">result = </span><span className="text-[#fd4444]">await</span> <span className="text-[#ff6b6b]">processData</span><span className="text-[var(--white)]">(data);</span>
                <br/>
                <br/>
                <span className="ml-4">// Return JSON response</span>
                <br/>
                <span className="ml-4 text-[#fd4444]">return</span> <span className="text-[var(--white)]">Response.json({'{'}</span>
                <br/>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#fd4444]/10 border border-[#fd4444]/30 rounded-xl p-6"
            >
              <Code className="h-10 w-10 text-[#fd4444] mb-4" />
            ...
            <motion.div
              ...
              className="bg-[#fd4444]/10 border border-[#fd4444]/30 rounded-xl p-6"
            >
              <Terminal className="h-10 w-10 text-[#fd4444] mb-4" />
            ...
            <motion.div
              ...
              className="bg-[#fd4444]/10 border border-[#fd4444]/30 rounded-xl p-6"
            >
              <Database className="h-10 w-10 text-[#fd4444] mb-4" />
            ...
            <motion.div
              ...
              className="bg-[#fd4444]/10 border border-[#fd4444]/30 rounded-xl p-6"
            >
              <Server className="h-10 w-10 text-[#fd4444] mb-4" />
            ...
            <motion.div
              ...
              className="bg-[#fd4444]/10 border border-[#fd4444]/30 rounded-xl p-6"
            >
              <Network className="h-10 w-10 text-[#fd4444] mb-4" />
            ...
            <motion.div
              ...
              className="bg-[#fd4444]/10 border border-[#fd4444]/30 rounded-xl p-6"
            >
              <Shield className="h-10 w-10 text-[#fd4444] mb-4" />
      ...
      {/* Use Cases */}
      <section className="py-20 bg-gradient-to-b from-black to-[#fd4444]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <ChromeText as="h2" className="text-3xl font-bold mb-4">
              Common Use Cases
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#fd4444]/5 border border-[#fd4444]/20 rounded-xl p-8">
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-[#fd4444]/20 to-[#ff6b6b]/20 rounded-2xl p-8 md:p-12 border border-[#fd4444]/30">
