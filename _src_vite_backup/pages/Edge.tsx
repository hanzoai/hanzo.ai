    ...
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)]">
      ...
      <section className="py-20 lg:py-32 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="bg-orange-400/10 border border-orange-400/20 rounded-full px-4 py-1 inline-block mb-4">
              <span className="text-orange-300 text-sm font-medium">Ultra-Low Latency</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-orange-300 to-orange-400">
              Hanzo Edge
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-orange-500 hover:bg-cyan-700 text-[var(--white)] px-8 py-6 text-lg">
                Get Started
              </Button>
              <Button variant="outline" className="border-orange-400/30 text-[var(--white)] hover:bg-cyan-900/20 px-8 py-6 text-lg">
                View Documentation
              </Button>
            </div>
          </div>
          ...
          {/* Hero Visual */}
          <div className="relative bg-cyan-900/20 border border-orange-400/20 rounded-xl p-8 overflow-hidden">
            <div className="absolute inset-0 bg-grid-white/5 [mask-image:linear-gradient(to_bottom,white,transparent)]"></div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex flex-col items-center p-4 bg-[var(--black)]/30 rounded-lg border border-orange-400/30">
                <Globe className="h-10 w-10 text-orange-300 mb-4" />
                <h3 className="text-lg font-semibold mb-2">Global Network</h3>
                <p className="text-center text-neutral-300">Deploy to 200+ locations worldwide in seconds</p>
              </div>
              
              <div className="flex flex-col items-center p-4 bg-[var(--black)]/30 rounded-lg border border-orange-400/30">
                <Zap className="h-10 w-10 text-orange-300 mb-4" />
              ...
              <div className="flex flex-col items-center p-4 bg-[var(--black)]/30 rounded-lg border border-orange-400/30">
                <Network className="h-10 w-10 text-orange-300 mb-4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-cyan-900/20 border border-orange-400/30 rounded-xl p-6"
            >
              <Code className="h-10 w-10 text-orange-300 mb-4" />
            ...
            <motion.div 
              ...
              className="bg-cyan-900/20 border border-orange-400/30 rounded-xl p-6"
            >
              <Cloud className="h-10 w-10 text-orange-300 mb-4" />
            ...
            <motion.div 
              ...
              className="bg-cyan-900/20 border border-orange-400/30 rounded-xl p-6"
            >
              <Server className="h-10 w-10 text-orange-300 mb-4" />
            ...
            <motion.div 
              ...
              className="bg-cyan-900/20 border border-orange-400/30 rounded-xl p-6"
            >
              <Shield className="h-10 w-10 text-orange-300 mb-4" />
      ...
      <section className="py-20 bg-gradient-to-b from-black to-cyan-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-cyan-900/10 border border-orange-400/20 rounded-xl p-8">
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-cyan-900/20 to-red-900/20 rounded-2xl p-8 md:p-12 border border-orange-400/30">
