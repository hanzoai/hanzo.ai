    ...
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)]">
      ...
      <section className="pt-24 pb-16 px-4 md:px-8 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center">
          ...
          >
            <Building2 className="w-4 h-4 text-[#fd4444]" />
              ...
              {category.products.map((product, index) => {
                ...
                return (
                  ...
                  >
                    <Link
                      to={product.href}
                      className="block bg-neutral-900/50 border border-neutral-800 rounded-xl p-5 hover:border-[#fd4444]/30 transition-colors group h-full"
                    >
                      <div className="w-10 h-10 rounded-lg bg-[#fd4444]/10 flex items-center justify-center mb-3">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {whiteLabelProducts.map((product, index) => {
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#fd4444]/20 to-[#ff6b6b]/10 flex items-center justify-center mb-4">
