      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="px-6 py-3 bg-[#ffffff] hover:bg-[#cccccc] rounded-md transition duration-200">
              Get Started
            </button>
