      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex flex-col items-center text-center">
            <div className="text-5xl text-[#ffffff] mb-4">"</div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
          <motion.div
            ...
            className="p-4"
          >
            <div className="text-3xl font-bold text-[#ffffff] mb-2">200+</div>
          ...
          <motion.div
            ...
            className="p-4"
          >
            <div className="text-3xl font-bold text-[#ffffff] mb-2">99.999%</div>
          ...
          <motion.div
            ...
            className="p-4"
          >
            <div className="text-3xl font-bold text-[#ffffff] mb-2">190+</div>
