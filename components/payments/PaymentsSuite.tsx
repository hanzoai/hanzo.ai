              ...
              <div className="text-center">
                ...
                <div className="flex items-end justify-center space-x-2 h-32 mb-4">
                  {[20, 35, 28, 45, 60, 75, 90].map((height, i) => (
                    <div 
                      key={i} 
                      className="bg-gradient-to-t from-[#ffffff] to-[#ff6b6b] rounded-t w-6"
                      style={{height: `${height}%`}}
                    ></div>
                  ))}
                </div>
