...
export const AgencyCard = ({ onCardClick }: AgencyCardProps) => {
  return (
    <a
      ...
      className="block rounded-xl bg-gradient-to-b from-white/30 to-white/10 border border-white/20 cursor-pointer hover:border-white/40 transition-colors p-4 h-[200px] flex flex-col justify-between"
      onClick={onCardClick}
    >
      <div>
      ...
      <div className="flex items-center text-xs text-white font-medium group">
