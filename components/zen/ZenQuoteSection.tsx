...
const ZenQuoteSection: React.FC<ZenQuoteSectionProps> = ({ quote, attribution }) => {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background to-gray-950/30">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="relative p-12 bg-gradient-to-br from-gray-900/40 to-background backdrop-blur-lg border border-gray-800/30 rounded-lg">
