  ...
  return (
    <section className="py-16 bg-gradient-to-b from-black to-gray-900/40">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 flex flex-col items-center">
              <ShoppingCart className="h-12 w-12 text-white/60 mb-4" />
              ...
              <Button 
                className="mt-auto bg-white/10 hover:bg-white/10 text-black"
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 flex flex-col items-center">
              <Book className="h-12 w-12 text-white/60 mb-4" />
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 flex flex-col items-center">
              <Code className="h-12 w-12 text-white/60 mb-4" />
        ...
        <div className="bg-white/5 border border-white/20 rounded-lg p-6 text-center max-w-3xl mx-auto">
