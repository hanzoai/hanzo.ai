...
const TechCard = ({ icon, title, description }: TechCardProps) => {
  return (
    <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6 hover:border-white/20 transition-all duration-300">
      <div className="mb-4">
        {icon}
      </div>
