...
const DemoShowcase: React.FC = () => {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-black to-[#ffffff]/10" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <div className="inline-block px-4 py-1 rounded-full bg-[#ffffff]/20 border border-[#ffffff]/30 text-[#ff6b6b] text-sm font-medium mb-6">
              See it in action
            </div>
            ...
            <Button 
              className="bg-[#ffffff] hover:bg-[#cccccc] rounded-full px-6 py-6 text-[var(--white)]"
            >
