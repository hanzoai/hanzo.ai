  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-16">
      ...
      <motion.div
        ...
        className="bg-[#ffffff]/20 border border-[#ffffff]/30 rounded-xl p-8 relative overflow-hidden"
      >
        <div className="flex items-center gap-4 mb-4">
          <div className="p-3 bg-[#ffffff]/30 rounded-full">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#ff6b6b]">
        ...
        <a href="/agency" className="inline-flex items-center text-[#ff6b6b] hover:text-[#ffffff] transition-colors group">
