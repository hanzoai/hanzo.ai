...
const AdditionalFeatures = () => {
  return (
    <div className="bg-gradient-to-r from-[#ffffff]/10 to-[#ff6b6b]/10 rounded-2xl p-8 border border-[#ffffff]/30 mt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-[var(--black)]/30 p-4 rounded-lg">
          <Brain className="h-8 w-8 text-[#ffffff] mb-3" />
        ...
        <div className="bg-[var(--black)]/30 p-4 rounded-lg">
          <MessageSquare className="h-8 w-8 text-[#ffffff] mb-3" />
        ...
        <div className="bg-[var(--black)]/30 p-4 rounded-lg">
          <Box className="h-8 w-8 text-[#ffffff] mb-3" />
        ...
        <div className="bg-[var(--black)]/30 p-4 rounded-lg">
          <Database className="h-8 w-8 text-[#ffffff] mb-3" />
      ...
      <div className="mt-8 text-center">
        <Button className="bg-[#ffffff] hover:bg-[#cccccc] text-[var(--white)] px-6 py-2 text-lg">
          Explore the API
        </Button>
      </div>
    </div>
