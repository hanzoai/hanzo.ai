  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-gray-950 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-2/3 h-1/2 bg-white/5 rounded-full blur-3xl transform -translate-x-1/4 -translate-y-1/4"></div>
        <div className="absolute bottom-0 right-0 w-full h-1/2 bg-white/5 rounded-full blur-3xl transform translate-x-1/4 translate-y-1/4"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
          ...
          >
            <Button size="lg" className="bg-white hover:bg-[#cccccc]">
              Get Started Free
        ...
        >
          <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-8 hover:bg-gray-900/40 transition-colors">
            ...
            <a href="#" className="flex items-center text-white hover:text-white/70 group">
              Explore Docs
