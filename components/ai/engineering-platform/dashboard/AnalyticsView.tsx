        ...
        <div className="bg-gray-800/40 border border-gray-700/40 rounded-lg p-3">
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            <div className="flex items-center">
              ...
              <span className="text-xs text-foreground/80">GPT-4o (42%)</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 rounded-full bg-primary/10 mr-2"></div>
              <span className="text-xs text-foreground/80">Claude 3 (28%)</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 rounded-full bg-primary/10 mr-2"></div>
              <span className="text-xs text-foreground/80">Llama 3 (15%)</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 rounded-full bg-primary/10 mr-2"></div>
