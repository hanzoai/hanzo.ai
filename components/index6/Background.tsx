...
const Background: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 -z-10">
      ...
      {/* Animated glow spots */}
      <motion.div
        className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full blur-[100px] bg-primary/10"
        animate={{
          scale: [1, 1.2, 1],
      ...
      <motion.div
        className="absolute bottom-1/3 right-1/3 w-64 h-64 rounded-full blur-[100px] bg-primary/10"
        animate={{
          scale: [1, 1.3, 1],
