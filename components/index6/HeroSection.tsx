    ...
    <section ref={containerRef} className="pt-32 pb-20 px-4 md:px-8 min-h-[90vh] flex flex-col justify-center relative">
      ...
      >
        ...
        <motion.p 
          ...
          className="mt-6 mb-8 text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto"
        >
        ...
        >
          <Button 
            size="lg" 
            className="bg-primary hover:bg-[#cccccc] text-[var(--white)] px-8 py-6 text-lg"
          ...
          <Button 
            size="lg" 
            variant="outline"
            className="border-white/30 hover:border-white/30/70 text-[var(--white)] hover:text-[var(--white)] px-8 py-6 text-lg"
